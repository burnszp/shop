...
<body flag="admin">
		...
		<div class="col-md-12">
			<div class="panel panel-info">
				<div class="panel-heading">
					...
					<div style="display: inline; float: right; margin-top: -5px;">
						<div class="btn-group">
							...
							<li><a href="${ctx}/admin/customer?method=add" flag="add">新增 </a></li> 
				...
				<div class="panel-body">
						...
						<tbody>
							<c:forEach items="${pager.list}" var="rec" varStatus="status">
								<tr>
									...
									<td><a href="${ctx}/admin/customer?method=view&id=${rec.id}">${rec.username}</a></td>
									<td>${rec.phone}</td>
									<td>${rec.addr}</td>
									<td>${rec.score}</td>
								</tr>
					...
					<div class="pagination" id="page" url="${ctx}/admin/customer"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		seajs.use('${ctx}/resource/js/admin/customer')
	</script>
</body>
</html>
