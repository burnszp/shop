...
<body flag="admin">
		...
		<div class="col-md-12">
			<div class="panel panel-info">
					...
					<div style="display: inline; float: right; margin-top: -5px;">
						<div class="btn-group">
							...
							<ul role="menu" class="dropdown-menu">
								<li><a href="${ctx}/admin/order?ostatus=2"  >已处理订单
								</a></li>
								<li><a href="${ctx}/admin/order?ostatus=1" >未处理订单 </a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="panel-body">
						...
						<tbody>
							<c:forEach items="${pager.list}" var="rec" varStatus="status">
								<tr>
									...
									<td><a href="${ctx}/admin/order?method=view&id=${rec.id}">${rec.orderId}</a></td>
					...
					<div class="pagination" id="page" url="${ctx}/admin/order"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		seajs.use('${ctx}/resource/js/admin/order')
	</script>
</body>
</html>
